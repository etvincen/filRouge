...
class Document():
    ...
    SWAGGER - ec2-XX-XX-XXX-XX.eu-west-1.compute.amazonaws.com:24222/swaggerUI/
    ...
    def writeToLocal(self):
        path = os.path.join(os.path.join(os.path.join(os.getcwd(),'app'), self.output_path), self.doc_name)
        print(path)
        opt = ''
    ...
    def extract_images(self):
        ...
        with Image(blob= self.file, format='ico') as i:
            ...
            i.save(filename = os.path.join(os.path.join(os.path.join(os.getcwd(),'app'), self.output_path), self.doc_name))
